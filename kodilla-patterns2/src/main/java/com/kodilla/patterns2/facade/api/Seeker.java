...
public class Seeker {
    private static final Logger LOGGER =
            LoggerFactory.getLogger(Seeker.class);
    ...
    public void logEvent(OrderDto orderDto, Long userId, Object object){
        LOGGER.info("Class: " + object.getClass().getName() + ", Args: order: " + orderDto + " and user: "+ userId);
    }
    ...
    public Object MeasureTime(final ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            LOGGER.info("The time needed:" + ( end - begin ) + "[ms].");
