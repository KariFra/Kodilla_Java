...
import com.kodilla.stream.forumuser.ForumUser2;
import org.junit.Assert;
import org.junit.Test;

public class ForumUser2TestSuite {

    @Test
    public void testGetLocationsOfFriends() {
        //Given
        //Create users
        ForumUser2 user1 = new ForumUser2("alan01", "Alan Kosovsky", "Washington");
        ForumUser2 user2 = new ForumUser2("ethanreard", "Ethan Reard", "Miami");
        ForumUser2 user3 = new ForumUser2("eRiK", "Erik Hull", "Key West");
        ForumUser2 user4 = new ForumUser2("booth", "Mya Booth", "Washington");
        ForumUser2 user5 = new ForumUser2("nicole1987", "Nicole Lee", "Orlando");
        ForumUser2 user6 = new ForumUser2("nobody", "Briana Williams", "Miami");
        ForumUser2 user7 = new ForumUser2("bigmac", "Robert Macdonald", "Washington");
        ForumUser2 user8 = new ForumUser2("thebigone", "Clay Small", "Orlando");
        ForumUser2 user9 = new ForumUser2("user121212", "Marisa Frank", "Washington");
        ForumUser2 user10 = new ForumUser2("lawyer", "Lexie John", "Miami");
